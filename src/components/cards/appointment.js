...
class CardAppointment extends Component {
	...
	confirmCancel = props => {
		return  <div className="text-center">
                    <div className="mb-3">Após o cancelamento o valor será convertido  em um créditos e você perderá 15% do valor.</div>
                    <div className="mb-3 color-red">Está operação não poderá ser revertida</div>
                    <BtnMain
        	...
        	<div className="rounded bg-white border p-2 mb-3 h-100">
            		...
            		<div className="col-sm-7">
            			<div className="d-flex align-items-start flex-column h-100">
            				<div>
		        				...
		        				<span className="color-grey">Vendido e realizado por</span><br />
            	...
            	<div className="row mb-2">
            		<div className="col-md-6 mb-2">
            			<div className="color-grey">Profissional:</div>
            			<div>Margarette Reis</div>
            		</div>
            		<div className="col-md-6">
            			<div className="color-grey">Agendamento:</div>
            			<div>02/03/2018 às 11:45</div>
            		</div>
            	</div>
            	<div className="border-bottom mb-2"></div>
            	<div className="color-grey">Contato:</div>
            	<div className="mb-2">(11) 96162-1832</div>
            	<div className="color-grey">Local:</div>
            	...
            	<div className="row mb-2">
            		<div className="col-sm-6">
            			<div className="color-grey">Validade:</div>
            			<div>09/03/2018 às 10:15</div>
            			<sup className="color-grey">(30 dias)</sup>
            		</div>
            		<div className="col-sm-6">
