...
export default class Home extends Component {
  ...
  componentDidMount() {
    ...
    {
      headers: {
        apikey: '5612edff-bfae-4919-83ad-e8064b447a49',
      }
    })
    .then(res => {
      ...
      const banner_list = banner.map(obj => <Carousel.Item key={obj.id}><img width={900} height={445} alt="banner" src={obj.image_url} />{carousel_text}</Carousel.Item>);
